...
abstract class AbstractRelationshipTask2 implements Action, ServiceLocatorAwareInterface, TaskAwareInterface
{
    ...
    public function __invoke($params)
    {
        ...
        $iterator = $this->getServiceLocator()
            ->get(TaskIterator::class)
            ->getIterator($itemClasses, $start, $end);
    ...
    private function applyProcessor(Iterator $iterator): bool
    {
        ...
        try {
            ...
            $this->addAnomaly($unit['id'], $unit['subject'], $exception->getMessage());
        }
