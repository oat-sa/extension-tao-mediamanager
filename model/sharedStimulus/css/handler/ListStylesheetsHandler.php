...
class ListStylesheetsHandler extends ConfigurableService
{
    /**
     * @throws MissingParameterException
     */
    public function __invoke(ServerRequestInterface $request): ListStylesheets
    {
        $params = $request->getQueryParams();
        $this->validate($params);

        return new ListStylesheets($params['uri']);
    }
