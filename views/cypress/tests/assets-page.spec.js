...
describe('Assets Page', () => {
    ...
    describe('Assets page', () => {
        it('should be menu button', function () {
            cy.get('nav ul.main-menu li.active a span.icon-media').should('have.length', 1);
        });

        it('should be left panel with Assets tree', function () {
            cy.get('div.taotree-media').find('ul').children().should('not.to.have.length', 0);
        });
