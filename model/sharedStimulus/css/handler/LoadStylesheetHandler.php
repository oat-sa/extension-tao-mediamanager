...
class LoadStylesheetHandler extends ConfigurableService
{
    /**
    ...
    public function __invoke(ServerRequestInterface $request): LoadStylesheet
    {
        ...
        return new LoadStylesheet($params['uri'], $params['stylesheet']);
    }
    ...
    {
        RequestValidator::validateRequiredParameters($params, ['uri', 'stylesheet']);
        RequestValidator::securityCheckPath($params['stylesheet']);
    }
}
